...
namespace TMV.UI.RP.Common
{
  public class CyberColor
  {
    ...
    public void V_GetColorBold(
      DataTable _Dt,
      ref bool _Bold,
      ref bool _BackColor,
      ref bool _BackColor2,
      ref bool _ForeColor,
      ref string _FieldBold,
      ref string _FieldBackColor,
      ref string _FieldBackColor2,
      ref string _FieldForeColor)
    {
      if (_Dt == null)
        return;
